...
public class TesteAtualizarAcesso {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException, ParseException {
        ...
        objAcesso.setId_acesso(inteiro("Informe o Id do acesso que será atualizado"));
        ...
        System.out.println(acessoDAO.atualizarAcesso(objAcesso));
    }
}
